                ...
                <v-stepper v-model="step" :items="items" show-actions>
                        ...
                        <template v-slot:item.2>
                                ...
                                <v-card class="mx-auto" title="Confirmar Dados">
                                        <v-container>
                                                <v-text-field v-model="first" readonly color="primary"
                                                        label="Primeiro nome" variant="underlined"></v-text-field>

                                                <v-text-field v-model="last" readonly color="primary" label="Sobrenome"
                                                        variant="underlined"></v-text-field>
                                        ...
                                        <v-card-actions>
                                                ...
                                                <v-btn color="success"
                                                        v-if="first && last && username && email && password && terms != ''"
                                                        @click="sendData()">
                                                        Completar Registro
